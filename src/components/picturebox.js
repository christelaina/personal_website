...
const Picturebox = () => {
  const imagesArray = [
    ...
    {
      theme: "flowers",
      images: ["IMG_7676.jpg", "IMG_8097.jpg"],
      text: "always press or hang dry flowers for sentimental preservation.",
    },
    {
      theme: "kayaking",
      images: ["IMG_6507.jpg", "IMG_6646.jpg"],
      text: "first time back country camping. would highly recommend.",
    },
    {
      theme: "moments",
      images: [
